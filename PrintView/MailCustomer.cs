...
namespace PrintView
{
    ...
    {
        private static TcpClient MessageClient;
        ...
        public static void Connect()
        {
            ...
            MessageClient.Connect("pop.gmail.com", 995);

            stream = new SslStream(MessageClient.GetStream());
        ...
        private static void GetMessages(int number)
        {
            ...
            while (true)
            {
                ...
                if (response.Length > 4)
                {
                    ...
                    {
                        APICustomer.PostRequest<MessageInfoBindingModel,
