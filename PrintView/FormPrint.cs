...
namespace PrintView
{
    public partial class FormPrint : Form
    {
        ...
        public FormPrint(IPrintService service)
        {
            InitializeComponent();
        ...
        private void FormProduct_Load(object sender, EventArgs e)
        {
            if (id.HasValue)
            {
                try
                {
                    PrintViewModel view = service.GetElement(id.Value);
                    if (view != null)
                    {
        ...
        {
            var form = Container.Resolve<FormPrintIngredient>();
        ...
        private void buttonSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
               ...
               List<PrintIngredientBindingModel>();
                ...
                if (id.HasValue)
                {
                    service.UpdElement(new PrintBindingModel
                    {
                        Id = id.Value,
                ...
                {
                    service.AddElement(new PrintBindingModel
                    {
                        PrintName = textBoxName.Text,
                        Price = Convert.ToInt32(textBoxPrice.Text),
                        PrintIngredient = PrintIngredientBM
